...
export interface BasicNavigation {
    location: 'home' | 'send' | 'swap' | 'receive' | 'buy' | 'receive' | 'history' | 'legacy-settings' | 'legacy-settings-general' | 'legacy-settings-currency' | 'legacy-settings-networks' | 'settings' | 'settings-wallets' | 'settings-profiles' | 'settings-apps' | 'search' | 'search-tokens' | 'search-collectibles';
}
export type Navigation = BasicNavigation | CoinDetailsNavigation | CollectibleDetailsNavigation | CollectionDetailsNavigation | TransactionDetailsNavigation | SearchViewAllNavigation | SendCoinNavigation | SendCollectibleNavigation;
export type History = Navigation[];
export declare const useNavigationContext: any, NavigationContextProvider: any;
