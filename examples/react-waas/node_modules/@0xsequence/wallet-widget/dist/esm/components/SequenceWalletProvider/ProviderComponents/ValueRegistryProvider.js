...
export const ValueRegistryProvider = ({ children }) => {
    ...
    const { data: coinPrices = [], isLoading: isCoinPricesLoading } = useGetCoinPrices(coinBalancesUnordered.map(token => ({
    ...
    return _jsx(ValueRegistryContextProvider, { value: { valueRegistryMap, totalValue }, children: children });
};
