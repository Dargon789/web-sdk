...
export const Buy = () => {
    ...
    return (_jsx(TrailsWidget, { apiKey: config.projectAccessKey, trailsApiUrl: trailsApiUrl, sequenceIndexerUrl: sequenceIndexerUrl, sequenceNodeGatewayUrl: sequenceNodeGatewayUrl, appUrl: "https://sequence.app", sequenceApiUrl: sequenceApiUrl, renderInline: true, theme: trailsTheme, mode: "fund", toAddress: address || null, customCss: resolvedCustomCss, hideDisconnect: true, hideAddWallet: true }));
};
