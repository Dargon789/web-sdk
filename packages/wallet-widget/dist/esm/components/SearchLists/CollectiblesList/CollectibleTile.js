...
export const CollectibleTile = ({ balance, onTokenClick }) => {
    const onClick = () => {
    ...
    return (_jsxs("div", { className: "select-none cursor-pointer relative", onClick: onClick, children: [_jsx(TokenTileImage, { src: imageUrl, symbol: symbol }), _jsx(NetworkImage, { chainId: balance.chainId, className: `absolute z-1`, style: {
